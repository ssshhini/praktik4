        ...
        static void Main(string[] args)
        {
            ...
            switch (sw)
            {
                case 1:
                    ...
                    //L1 = (Math.Sqrt(Math.Pow(e1, x1) - Math.Pow(Math.Cos(Math.Pow(x1, 2) * Math.Pow(a1, 5)), 4) + Math.Pow(Math.Atan(a1 - Math.Pow(x1, 5)), 4) / (e1 * Math.Sqrt(Math.Abs(a1 + x1 * Math.Pow(c1, 4))))));
                ...
                case 2:
                    ...
                    //Console.WriteLine($"L = {Math.Pow(1 / Math.Tan(c2), 2) + (2 * Math.Pow(x2, 2) + 5) / (Math.Sqrt(c2 + t2))}");
                ...
                case 3:
                    ...
                    //Console.WriteLine((Math.Tan(Math.Pow(y3, 3) - Math.Pow(h3, 4)) + Math.Pow(h3, 2)) / (Math.Pow(Math.Sin(h3 + y3), 3)));
                ...
                case 4:
                    ...
                    //Console.WriteLine($"F = {(Math.Sqrt(Math.Pow(2 + y4, 2) + Math.Pow(Math.Sqrt(Math.Sin(y4 + 5)), 1/7))) / (Math.Log(x4 + 1) - Math.Pow(y4, 3))}");
                ...
                case 5:
                    ...
                    //Console.WriteLine($"G = {(Math.Tan((Math.Pow(x5, 4) - 6)) - Math.Pow(Math.Cos((z5 + x5 * y5)), 3)) / (Math.Pow(Math.Cos(Math.Pow(x5, 3) * Math.Pow(c5, 2)), 4))}");
                ...
                case 6:
                    ...
                    //Console.WriteLine($"K = {(Math.Sqrt(x6 + b6 - a6) + Math.Log(y6)) / (1 / Math.Tan(b6 + a6))}");
                ...
                case 7:
                    ...
                    //Console.WriteLine($"D = {(Math.Cos(Math.Pow(x7, 3) + 6) - Math.Sin(y7 - a7)) / (Math.Log(Math.Pow(x7, 4)) - 2 * Math.Pow(Math.Sin(x7), 5))}");
                ...
                case 8:
                    ...
                    //Console.WriteLine($"P = {(Math.Pow(a8, 5) + Math.Pow(Math.Sin(y8 - c8), 4)) / (Math.Pow(Math.Sin(x8 + y8), 3) + Math.Abs(x8 - y8))}");
